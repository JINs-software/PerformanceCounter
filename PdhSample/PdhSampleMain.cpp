...
CONST LPWSTR BROWSE_DIALOG_CAPTION = (CONST LPWSTR)L"Select a counter to monitor.";
...
void wmain(void)
{
    ...
    //BrowseDlgData.bSingleCounterPerAdd = FALSE;     // 선택 가능한 인스턴스 쿼리는 에러가 발생하여 나오지 않는다. 
